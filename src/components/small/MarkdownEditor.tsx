  ...
  return (
    <div className="border-t-2 mt-2.5 relative w-full flex-1 min-h-0 flex flex-col dark:bg-black bg-white overflow-hidden">
      ...
      <textarea
        ...
        className="relative z-10 w-full h-175 py-6 px-4 overflow-y-auto scrollbar-thin font-mono text-sm resize-none bg-transparent focus:outline-none border-none caret-black"
      />
    </div>
  );
}
