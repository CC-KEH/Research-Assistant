...
export function TitleBar({
  ...
  return (
    <div
      ...
      className="flex items-center justify-between h-7 w-full shrink-0 bg-background border-b border-border select-none"
    >
      {/* Left: icon + title */}
      <div
        data-tauri-drag-region
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center w-[46px] h-full border-none
                  ...
                  ${
                    isClose
                      ? "hover:bg-red-500 hover:text-white active:bg-red-900"
